...
struct AssetBannerView: View {
    let bannerList: [AssetBanner] = [
        ...
        AssetBanner(title: "주말 이벤트", description: "주말 이벤트 놓치지마세요", backgroundColor: .yellow),
        AssetBanner(title: "깜짝 이벤트", description: "엄청난 이벤트에 놀라지마세요", backgroundColor: .blue),
    ...
    var body: some View {
        ...
        ZStack(alignment: .bottomTrailing) {
            ...
            PageControll(numberOfPages: bannerList.count, currentPage: $currentPage)
